...
This file owns migrations, seed, schema conventions, and the repo-ring query/pool/transaction mechanics. The pool and `withTransaction` live in the db aspect (`./backend.md` → *Aspects*); provisioning lives in `./infra.md`.
