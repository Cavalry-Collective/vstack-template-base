...
| [`seo/`](seo/README.md) | Search discoverability of public pages — indexable rendering, metadata, canonicals, sitemap | the seam items S1–S7: rendering, metadata, canonical origin + redirects, sitemap/robots, not-found, structured data, locale alternates |
