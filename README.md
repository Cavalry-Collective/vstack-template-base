...
| `add-ons/` | Optional capability add-ons — agnostic patterns you opt into at Day-1 (test mode, OTP login, LLM calls); the active stack pack supplies their concrete bindings. See [`add-ons/README.md`](add-ons/README.md) |
