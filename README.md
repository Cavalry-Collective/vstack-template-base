...
| `design/` | UI mockups + the **design guide** (`design-guide.html` + `tokens.css`) — the visual keystone confirmed before UI work; ships as a neutral, token-driven system rebranded per project; reference, not part of the build |
